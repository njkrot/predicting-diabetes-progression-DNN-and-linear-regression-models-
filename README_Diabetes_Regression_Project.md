...
This project was created for ENGR-125 and expanded into a portfolio-style data science project. The goal was to connect Python, machine learning, and health-related data in a way that was more meaningful than using a random dataset.
